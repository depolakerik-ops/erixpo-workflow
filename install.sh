...
VERSION="0.4.0"
HOST_ARG="auto"
SKILL_NAMES=(erixpo erixpo-auto erixpo-docs erixpo-feature erixpo-fix erixpo-init erixpo-learn erixpo-new erixpo-review erixpo-search erixpo-uninstall erixpo-work)
SCRIPT_NAMES=(worktree.sh session-search.sh review-stage1.sh detect-host.sh)

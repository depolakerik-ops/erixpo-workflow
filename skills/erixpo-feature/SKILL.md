...
4. If the feature needs new infrastructure, do a **narrow** research pass ([research.md](../erixpo/references/research.md)) and ask before adding it. If the test harness is missing, **create it** ([testing.md](../erixpo/references/testing.md)) — do not ask whether to have tests.

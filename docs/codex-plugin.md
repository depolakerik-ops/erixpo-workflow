...
The marketplace resolves the plugin package published on `main`. A marketplace points to published content; adding a local development marketplace does not publish uncommitted changes.
